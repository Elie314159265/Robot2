...
from src.hand_control import HandDetector, FingerMapper
...
def process_frames(camera, detector, mapper, serial):
    ...
    while True:
        ...
        cv2.putText(frame, f"Detection: {avg_detection_time:.1f}ms", (10, 65),
