...
**注意:** PCA9685の電源はArduinoの5Vではなく、**外部電源（6V-12V）を推奨**します。サーボモーターは電流消費が大きいためです。
